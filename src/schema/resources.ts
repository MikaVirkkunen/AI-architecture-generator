...
export const AZURE_ICONS = {
  ...
  elasticSan: 'img/lib/azure2/storage/Storage_Accounts.svg',

  // ==================== SAP ====================
  sapHana: 'img/lib/azure2/compute/Virtual_Machine.svg',
  sapNetWeaver: 'img/lib/azure2/compute/Virtual_Machine.svg',
  sapApp: 'img/lib/azure2/compute/Virtual_Machine.svg',
  ...
  aiSearch: 'img/lib/azure2/ai_machine_learning/Serverless_Search.svg',
  aiFoundry: 'img/lib/azure2/ai_machine_learning/AI_Studio.svg',
  documentIntelligence: 'img/lib/azure2/ai_machine_learning/Form_Recognizers.svg',
  speechService: 'img/lib/azure2/ai_machine_learning/Speech_Services.svg',
  computerVision: 'img/lib/azure2/ai_machine_learning/Computer_Vision.svg',
  languageService: 'img/lib/azure2/ai_machine_learning/Language_Services.svg',
  contentSafety: 'img/lib/azure2/ai_machine_learning/Content_Safety.svg',
...
export const RESOURCES: Record<string, ResourceDefinition> = {
  ...
  'sapApp': {
    type: 'microsoft.workloads/sapvirtualinstances',
    displayName: 'SAP Application Server',
    icon: AZURE_ICONS.sapApp,
    width: 64, height: 64,
    containedBy: ['subnet', 'resourceGroup'],
    category: 'compute',
  },
  'sapRouter': {
    type: 'microsoft.network/virtualappliances',
  ...
  'hanaLargeInstance': {
    ...
    displayName: 'HANA Large Instance',
    icon: AZURE_ICONS.sapHana,
    width: 64, height: 64,
    containedBy: ['subnet', 'resourceGroup'],
    category: 'compute',
...
export const RESOURCE_ALIASES: Record<string, string> = {
  ...
  'netapp': 'netAppFiles', 'anf': 'netAppFiles', 'netapp files': 'netAppFiles', 'azure netapp': 'netAppFiles',
  'elastic san': 'elasticSan', 'azure elastic san': 'elasticSan', 'azure san': 'elasticSan',
  'sap': 'sapHana', 'sap hana': 'sapHana', 'hana': 'sapHana', 'sap on azure': 'sapHana',
  'sap netweaver': 'sapNetWeaver', 'sap nw': 'sapNetWeaver',
  'sap application server': 'sapApp', 'sap app server': 'sapApp', 'sap as': 'sapApp',
  'sap router': 'sapRouter', 'saprouter': 'sapRouter',
  'sap web dispatcher': 'sapWebDispatcher', 'web dispatcher': 'sapWebDispatcher',
  'hana large instance': 'hanaLargeInstance', 'hli': 'hanaLargeInstance', 'sap hli': 'hanaLargeInstance',
